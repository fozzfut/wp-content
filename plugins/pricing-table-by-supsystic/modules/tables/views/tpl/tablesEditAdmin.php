			...
			<div class="ptsTableSettingsShell row">
				...
				<div class="ptsTableSetting col-md-3">
					<label>
						...
						<i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(__('Animate column when mouse is hover on it. Will work ONLY on fronted, disabled in admin area WySiWyg editor as it can broke it in edit mode.', PTS_LANG_CODE))?>"></i>
					</label>
				</div>
				<div class="ptsTableSetting col-md-3">
					<label>
				...
				<div class="ptsTableSetting col-md-3">
					<label>
						...
						<i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(__('When device screen is small (mobile device or some tablets) usually table will go into responsive mode: all columns will be shown one-by-one below each other. But if you need to disable this feature - you can do this with this option. This feature influence only for frontend table view.', PTS_LANG_CODE))?>"></i>
					</label>
				</div>
