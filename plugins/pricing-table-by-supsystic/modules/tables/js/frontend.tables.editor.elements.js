...
ptsElementBase.prototype._initMovableMenu = function() {
	...
	this._menu.$().bind('ptsElMenuReposite', function(e, menu, top, left){
...
function ptsElement_txt(jqueryHtml, block) {
	...
	this._editorToolbarBtns = [
		['pts_fontselect'], ['pts_fontsizeselect'], ['bold', 'italic', 'strikethrough'], ['pts_link'], ['forecolor']
	];
...
ptsElement_txt.prototype._init = function() {
	...
	,	menubar: false
	,	plugins: 'pts_textcolor pts_link pts_fontselect pts_fontsizeselect'
...
ptsElement_img.prototype._createLink = function() {
	...
	if(!$link) {
		$link = jQuery('<a class="ptsLink" />').append( this._$.find('img') ).appendTo( this._$ );
