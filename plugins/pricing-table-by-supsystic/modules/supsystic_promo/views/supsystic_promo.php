...
class supsystic_promoViewPts extends viewPts {
	...
	public function getServerSettings() {
		return array(
            ...
            'MySQL' => array('value' => function_exists('mysql_get_server_info') ? @mysql_get_server_info() : __('Undefined', PTS_LANG_CODE)),
            'PHP Safe Mode' => array('value' => ini_get('safe_mode') ? __('Yes', PTS_LANG_CODE) : __('No', PTS_LANG_CODE), 'error' => ini_get('safe_mode')),
